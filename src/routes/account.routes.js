...
routes.get('/account/search/:store/:segment/:element', async (req, res)=>{
    ...
    try {
        ...
        if (user){
            ...
            favoritesOfUser = await modelFavorites.find({indexed:userId}); //todos los favoritos de este usuario,
            console.log("favoritesOfUser ....... :", favoritesOfUser);
        } else {
            searchProfile = [];
        }    
        ...
        if (searchCustomer){
            ...
            async function notification(){
                ...
                const newNotification = new modelMessage( { typeNote: 'shoppingCart-Cre',
                                                            ...
                                                            question: `¡Hola! ${CustomerName} te ha realizado una compra. Accede a la plataforma web para gestionarlo.`,
