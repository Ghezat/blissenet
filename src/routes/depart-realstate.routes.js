                                                ...
                                                if (boxImg.length !==0){
                                                    ...
                                                    async function createAD(){
                                                        ...
                                                        if (countImgAcept !==0){
                                                            ...
                                                            const Realstate =  new modelRealstate({ title: titleTrim, titleURL, category, sub_category, construcDate, mtrs2, tecnicalDescription, generalMessage, images : boxImg, price, user_id : user._id, username, blissName, country, countryCode, state_province : state, segment, scheduleAppointment : agendaAvailable  }); 
...
routes.post('/department/create/realstate/edit', async(req, res)=>{
    ...
    if (result) {
        const updates = await modelRealstate.findByIdAndUpdate(titleToEdit, { title: titleTrim, titleURL, category, sub_category, construcDate, mtrs2, tecnicalDescription, generalMessage, price });
