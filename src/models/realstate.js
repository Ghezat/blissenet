...
const SchemaRealstate = new Schema({
    title : { type: String },
    ...
    user_id : { type: String }, //el user_id del creador de este producto.
...
SchemaRealstate.plugin(mongoosePagination);

module.exports = model('realstateModel', SchemaRealstate, 'realstate');
