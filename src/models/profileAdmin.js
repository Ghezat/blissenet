...
const SchemaProfileAdmin = new Schema({
    platform : { type : String, default : "PolitanIA" }, //este username es el nombre por defecto de la plataforma.
    ...
    email : { type : String }, //email adminsitrativo de la empresa este dato será suministrado por la admisnitracion mayor de Politania para todas sus franquicias. 
